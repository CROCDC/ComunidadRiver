...
public class ListaDePosteosAdapter extends RecyclerView.Adapter {
    ...
    private class PosteoConVideoViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textViewFechaDePublicacion;
        private TextView textViewDelPosteo;
        private JzvdStd videoViewDelPosteo;
        private ImageView imageViewButtonLike;
        private TextView textViewCantLikes;
        private ImageView imageViewButtonDisLikes;
        private TextView textViewCantDisLikes;
        ...
        public PosteoConVideoViewHolder(@NonNull View itemView) {
            super(itemView);
            circleImageViewDeUsuario = itemView.findViewById(R.id.circleImageViewUsuario_celdaposteoconvideo);
            textViewNombreDelUsuario = itemView.findViewById(R.id.textViewNombreDeUsuario_celdaposteoconvideo);
            textViewFechaDePublicacion = itemView.findViewById(R.id.textViewFechaDePublicacionDelPosteo_celdaposteoconvideo);
            textViewDelPosteo = itemView.findViewById(R.id.textViewTextoDelPosteo_celdaposteoconvideo);
            videoViewDelPosteo = itemView.findViewById(R.id.videoViewDelPosteo_celdaposteoconvideo);
            imageViewButtonLike = itemView.findViewById(R.id.imageViewButtonLike_celdaposteoconvideo);
            textViewCantLikes = itemView.findViewById(R.id.textViewCantidadDeLikesDelComentario_celdaposteoconvideo);
            imageViewButtonDisLikes = itemView.findViewById(R.id.imageViewButtonDisLike_celdaposteoconvideo);
            textViewCantDisLikes = itemView.findViewById(R.id.textViewCantidadDeDisLikes_celdaposteoconvideo);
        }

        private void cargarPosteo(PosteoConVideo posteo) {
            Glide.with(context)
                    .load(posteo.getImagenDelUsuario())
                    .into(circleImageViewDeUsuario);
            textViewNombreDelUsuario.setText(posteo.getNombreDeUsuario());
            ...
            Uri uri = Uri.parse(posteo.getElementoMultimedial());



            videoViewDelPosteo.setUp(posteo.getElementoMultimedial(),"",Jzvd.SCREEN_WINDOW_NORMAL);
    ...
    private class PosteoSoloTextoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PosteoSoloTextoViewHolder(@NonNull View itemView) {
            super(itemView);
            circleImageViewDeUsuario = itemView.findViewById(R.id.circleImageViewUsuario_celdaposteosolotexto);
            textViewNombreDelUsuario = itemView.findViewById(R.id.textViewNombreDeUsuario_celdaposteosolotexto);
            textViewFechaDePublicacion = itemView.findViewById(R.id.textViewFechaDePublicacionDelPosteo_celdaposteosolotexto);
            textViewDelPosteo = itemView.findViewById(R.id.textViewTextoDelPosteo_celdaposteosolotexto);
            textViewCantLikes = itemView.findViewById(R.id.textViewCantidadDeLikesDelComentario_celdaposteosolotexto);
            imageViewButtonDisLikes = itemView.findViewById(R.id.imageViewButtonDisLike_celdaposteosolotexto);
            textViewCantDisLikes = itemView.findViewById(R.id.textViewCantidadDeDisLikes_celdaposteosolotexto);
        }
